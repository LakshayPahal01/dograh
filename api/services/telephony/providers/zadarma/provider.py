"""
Zadarma implementation of the TelephonyProvider interface.
"""
...
class ZadarmaProvider(TelephonyProvider):
    ...
    """
    PROVIDER_NAME = WorkflowRunMode.ZADARMA.value
    WEBHOOK_ENDPOINT = "zadarma-webhook"
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # Placeholder for actual Zadarma outbound call initiation
        logger.info(f"Initiating Zadarma call to {to_number}")
        return CallInitiationResult(
            call_id="mock-zadarma-call-id",
            status="initiated",
    ...
    async def verify_webhook_signature(
        ...
        **kwargs: Any
        ...
        # Placeholder for Zadarma webhook signature verification
        return True
    ...
    def can_handle_webhook(cls, webhook_data: Dict[str, Any], headers: Dict[str, str]) -> bool:
        return "zadarma" in headers.get("user-agent", "").lower() or "zadarma" in webhook_data

    @staticmethod
    def parse_inbound_webhook(webhook_data: Dict[str, Any]) -> NormalizedInboundData:
        return NormalizedInboundData(
            provider=ZadarmaProvider.PROVIDER_NAME,
